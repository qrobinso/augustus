...
class Settings(BaseSettings):
    ...
    tts_voice_host1: str = "21m00Tcm4TlvDq8ikWAM"  # Rachel (ElevenLabs) / en_US-lessac-medium (Piper)
    tts_voice_host2: str = "AZnzlk1XvdvUeBnXmlld"  # Domi (ElevenLabs) / en_US-amy-medium (Piper)
